  ...
  return knex('questions').del()
    .then(function () {
      ...
      return knex('questions').insert([
        ...
        {id: 13,questionContents: 'What were your Company\'s Total Cost of Goods Sold (COGS) last year? (COGS are direct materials and direct labor directly traceable to the production of what your company sells).' ,isMultipleChoice: false},
